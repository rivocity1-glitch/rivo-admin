  ...
  useEffect(() => {
    ...
    async function initNotifications() {
      try {
        ...
        const initialCount = Array.isArray(initialUnread?.data)
          ? initialUnread.data.length
          : 0;
        ...
        unsubscribe = NotificationService.subscribe(
          ...
          async (notification: any) => {
            ...
            const updatedCount = Array.isArray(updatedUnread?.data)
              ? updatedUnread.data.length
              : 0;
                ...
                >
                  ...
                  {(() => {
                    ...
                    > = {
                      ...
                      settlements: {
                        count:
                          sidebarCounts.settlements,
                        classes:
                          "bg-orange-500 text-white animate-pulse",
                      },
                      refunds: {
                        count:
                          sidebarCounts.refunds,
                        classes:
                          "bg-red-500 text-white animate-pulse",
                      },
                    };
                    ...
                    const targetConfig =
                      badgeConfigs[item.id];

                    if (
                      targetConfig &&
                      targetConfig.count > 0
                    ) {
                      return (
                        <span
